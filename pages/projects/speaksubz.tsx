...
function Speaksubz_ProjectPage() {
  const pName = "speaksubz";

  return (
    <PageTransition title="Speaksubz | SourceCraft" description="Speaksubz | SourceCraft">
      <Section>
        <Container>
      ...
      <Section invert={true} style={{ padding: "2% 0" }} transition={"trans3"}>
        ...
        <div style={{ paddingBlock: "5% 2%" }}>
          <GalleryCarousel invert={true} projectName={pName} slideWidth="50%" />
        </div>
          ...
          <CustomContainer>
            <div className="image">
              <div className="unset-img">
                <Image
                  src={"/gallery/projects/speaksubz/speaksubz-mockup-tablet.png"}
                  alt="Speaksubz image"
                  layout="fill"
      ...
      <NextProject side="left" projectName="fasting" />
    </PageTransition>
  );
}

export default Speaksubz_ProjectPage;
