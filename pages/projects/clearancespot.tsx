...
function Clearancespot_ProjectPage() {
  const pName = "clearancespot";

  return (
    <PageTransition
      title="Clearance Spot | SourceCraft"
      description="Clearance Spot | SourceCraft"
    >
      <Section>
        <Container>
      ...
      <Section invert={true} style={{ padding: "2% 0" }} transition={"trans3"}>
        ...
        <div style={{ paddingBlock: "5% 2%" }}>
          <GalleryCarousel invert={true} projectName={pName} slideWidth="35%" />
        </div>
          ...
          <CustomContainer>
            <div className="image">
              <div className="unset-img">
                <Image
                  src={"/gallery/projects/clearancespot/clearance-spot-screenshot1.png"}
                  alt="Speaksubz image"
                  layout="fill"
      ...
      <NextProject side="left" projectName="keto" />
    </PageTransition>
  );
}

export default Clearancespot_ProjectPage;
